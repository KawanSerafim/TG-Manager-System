...
/**
 * Mapa que linka a entidade de domínio da turma com o seu modelo de dados,
...
public class StudentGroupMapper {
    ...
    /**
     * Método que converte o modelo de dados da turma para a
    ...
    public static StudentGroup toDomain(StudentGroupData data) {
        ...
        /* Chama o construtor da entidade de domínio da turma, colocando
         * no valor do curso, ano e semestre, os mesmos que estão no modelo 
         * de dados.
         */
