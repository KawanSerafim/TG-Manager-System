...
/**
 * Implementador de porta de saída.
 * Determina o funcionamento da leitura de dados vindo de um arquivo em Excel.
 */
@Component
public class ExcelStudentDataReader implements StudentDataReader {
    ...
    public FileData read(InputStream fileStream) {
        ...
        try(Workbook workbook = new XSSFWorkbook(fileStream)) {
            ...
            /* Pega a primeira linha do arquivo. No caso, o cabeçalho. */
            ...
            /* Converte a célula A1 em um valor numérico. */
            ...
            for(int i = 1; i <= sheet.getLastRowNum(); i++) {
                ...
                /* Pega a linha de acordo com o índice i. */
                Row row = sheet.getRow(i);

                /* Pula linhas em branco. */
                if(row == null) continue;

                /* Pega o conteúdo da linha i e coluna A, e salva no nome. */
                String name = getCellStringValue(row.getCell(0));

                /* Pega o conteúdo da linha i e coluna B, e salva no RA. */
                String registration = getCellStringValue(
                    
                    row.getCell(1)
                );

                /* Só adiciona na lista se nome e RA conterem valores. */
