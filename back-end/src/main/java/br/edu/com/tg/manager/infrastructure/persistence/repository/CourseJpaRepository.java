 ...
 * curso. O framework reconhece os nomes dos métodos e os executa em tempo de 
...
public interface CourseJpaRepository extends JpaRepository<CourseData, Long> {
    ...
    /**
     * Método responsável por realizar a busca de um objeto do cursoatravés de 
     * seu nome. A escrita 'findByName' é proposital, pois o hibernate 
     * reconhece o tipo da operação justamente através da nomeação do método.
