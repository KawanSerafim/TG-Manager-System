...
/**
 * Interface de repositório Spring Boot Data JPA para entidade de domínio da 
 * turma. O framework reconhece os nomes dos métodos e os executa em tempo de 
 ...
 */
@Repository
public interface StudentGroupJpaRepository extends
JpaRepository<StudentGroupData, Long>{

    /**
     * Método responsável por realizar a busca de um objeto da turma através de 
     * seu curso, ano e semestre. A escrita 'findByCourseAndYearAndSemester' é 
     * proposital, pois o hibernate reconhece o tipo da operação justamente 
     * através da nomeação do método.
     ...
     */
    Optional<StudentGroupData> findByCourseAndYearAndSemester(
        CourseData course,
        Integer year,
        Integer semester
    );
