...
/**
 * Mapa que linka a entidade de domínio do curso com o seu modelo de dados,
...
public class CourseMapper {
    ...
    /**
     * Método que converte o modelo de dados do curso para a
    ...
    public static Course toDomain(CourseData data) {
        ...
        /* Chama o construtor da entidade de domínio do curso, colocando
         * no valor do nome, o mesmo que está no modelo de dados.
         */
