 ...
 * de domínio do aluno. O framework reconhece os nomes dos
...
public interface StudentJpaRepository extends JpaRepository<StudentData, Long> {
    ...
    /**
     * Método responsável por realizar a busca de um objeto do aluno
     * através da sua matrícula (RA).
     * A escrita 'findByRegistration' é proposital, pois 
